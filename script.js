        ...
        <div className="bg-background text-foreground p-8">
            ...
            <section className="my-12">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <img src="https://drive.google.com/uc?export=view&id=1WmGLVNjE1bTUsefZoJt8ZjhWpB74ARGs" alt="Katalog Sepatu Nasional" className="w-16 h-16" />
                    <img src="https://drive.google.com/uc?export=view&id=12xuDxpxunXcL9e5nb3zGda2Nrn0rMDcg" alt="The Pavilion" className="w-16 h-16" />
                    <img src="https://drive.google.com/uc?export=view&id=1tem3n7KM8I71qVJmevgusjNavrbzX5gt" alt="PT Cipta Adi Surya" className="w-16 h-16" />
                </div>
            </section>
